export const Cafes=[
  ...
  },
  {
    ...
    img:".../../public/exGel.svg",
    tipos:["TRADICIONAL","GELADO"],
    descricao:"Bebida preparada com café expresso e cubos de gelo",
    valor:9.90
  },
  {
    nome:"Café com leite",
    img:".../../public/cafeLeite.svg",
    tipos:["TRADICIONAL","COM LEITE"],
    descricao:"Meio a meio de expresso com leite vaporizado",
    valor:9.90
  },
  {
    nome:"Latte",
    img:".../../public/latte.svg",
    tipos:["TRADICIONAL","COM LEITE"],
  ...
  {
    nome:"Irlandês",
    img:".../../public/irlandes.svg",
    tipos:["ESPECIAL","ALCOLICO"],
